...
local function ShowKeyGate(onSuccess)
    ...
    Title.Text = "Banana Peel - Hutan BY Vii"
    Title.Parent = Card
    ...
    Sub.Text = "Masukkan key untuk membuka script. Key WAJIB dimasukkan setiap kali script dijalankan. Minta key ke Vii"
    Sub.Parent = Card
